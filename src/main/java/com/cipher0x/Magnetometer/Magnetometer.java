...
public class Magnetometer {
  ...
  private Vector3d getMagVectors(String magLine){
  ...
  private List<String> getMagneticLines(List<String> hexLine) {
  ...
  private final List<String> getMagnoLines(String hexBuffer) {
  ...
  private final String hexToFormattedHex(String strIn) {
